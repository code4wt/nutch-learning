...
public class CrawlDbReducer implements
    ...
    /**
     * reduce 主要做了如下事情：
     * 1. 通过 while (values.hasNext()) 对重复的 <url, crawlDatum> 实现去重
     * 2. 对 Fetch 阶段产生的结果进行处理
     *     a. 更新 crawlDatum 状态字段，将 STATUS_FETCH_ 开头的状态更新为相应的 STATUS_DB_ 开头的状态
     *     b. 更新 fetchTime
     * 3. 清除 crawlDatum.metaData 中的 WRITABLE_GENERATE_TIME_KEY 域
     * @param key
     * @param values
     * @param output
     * @param reporter
